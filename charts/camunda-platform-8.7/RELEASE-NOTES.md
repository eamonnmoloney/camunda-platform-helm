...
## [camunda-platform-12.10.0](https://github.com/camunda/camunda-platform-helm/releases/tag/camunda-platform-12.10.0) (2026-05-19)

### Features

- Explicit lifecycle fixtures in ci-test-config.yaml (#6103)

### Fixes

- Test Helm 3 or 4 and use helm v4 for dev (#5918)
- Normalize trailing whitespace in golden file writer (#6159)
...
```shell
cosign verify-blob camunda-platform-12.10.0.tgz \
  --bundle "camunda-platform-12.10.0-cosign-bundle.json" \
  --certificate-identity-regexp "https://github.com/camunda/camunda-platform-helm" \
  --certificate-oidc-issuer "https://token.actions.githubusercontent.com"
```

For detailed verification instructions, check the steps in the `camunda-platform-12.10.0-cosign-verify.sh` file.
