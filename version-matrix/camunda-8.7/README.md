...
- Helm values: [12.10.0](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.10.0#parameters)
- Helm CLI: [4.1.4](https://github.com/helm/helm/releases/tag/v4.1.4)

Camunda images:

- docker.io/camunda/connectors-bundle:8.7.20
- docker.io/camunda/console:8.7.104
- docker.io/camunda/identity:8.7.19
- docker.io/camunda/operate:8.7.29
- docker.io/camunda/optimize:8.7.21
- docker.io/camunda/tasklist:8.7.29
- docker.io/camunda/web-modeler-restapi:8.7.21
- docker.io/camunda/web-modeler-webapp:8.7.21
- docker.io/camunda/web-modeler-websockets:8.7.21
- docker.io/camunda/zeebe:8.7.29
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.9.0](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.9.0#parameters)
...
- docker.io/camunda/web-modeler-webapp:8.7.21
- docker.io/camunda/web-modeler-websockets:8.7.21
- docker.io/camunda/zeebe:8.7.28
- docker.io/camunda/zeebe:8.7.29
- registry.camunda.cloud/camunda/keycloak:26.3.3
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.8.6](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.8.6#parameters)
- Helm CLI: [3.20.2](https://github.com/helm/helm/releases/tag/v3.20.2)
...
- docker.io/camunda/console:8.7.104
- docker.io/camunda/identity:8.7.18
- docker.io/camunda/operate:8.7.28
- docker.io/camunda/optimize:8.7.20
- docker.io/camunda/tasklist:8.7.28
- docker.io/camunda/web-modeler-restapi:8.7.20
- docker.io/camunda/web-modeler-webapp:8.7.20
- docker.io/camunda/web-modeler-websockets:8.7.20
- docker.io/camunda/zeebe:8.7.28
- registry.camunda.cloud/camunda/keycloak:26.3.3
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.8.2](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.8.2#parameters)
- Helm CLI: [3.20.0](https://github.com/helm/helm/releases/tag/v3.20.0)

Camunda images:

- docker.io/camunda/connectors-bundle:8.7.16
- docker.io/camunda/console:8.7.102
- docker.io/camunda/identity:8.7.16
- docker.io/camunda/keycloak:26.3.3
- docker.io/camunda/operate:8.7.25
- docker.io/camunda/optimize:8.7.18
- docker.io/camunda/tasklist:8.7.25
- docker.io/camunda/web-modeler-restapi:8.7.17
- docker.io/camunda/web-modeler-webapp:8.7.17
- docker.io/camunda/web-modeler-websockets:8.7.17
- docker.io/camunda/zeebe:8.7.25
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.8.1](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.8.1#parameters)
- Helm CLI: [3.20.0](https://github.com/helm/helm/releases/tag/v3.20.0)
...
- docker.io/camunda/identity:8.7.16
- docker.io/camunda/keycloak:26.3.3
- docker.io/camunda/operate:8.7.24
- docker.io/camunda/optimize:8.7.18
- docker.io/camunda/tasklist:8.7.24
- docker.io/camunda/web-modeler-restapi:8.7.17
- docker.io/camunda/web-modeler-webapp:8.7.17
- docker.io/camunda/web-modeler-websockets:8.7.17
- docker.io/camunda/zeebe:8.7.24
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.7.6](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.7.6#parameters)
- Helm CLI: [3.19.4](https://github.com/helm/helm/releases/tag/v3.19.4)

Camunda images:

- docker.io/camunda/connectors-bundle:8.7.15
- docker.io/camunda/console:8.7.97
- docker.io/camunda/identity:8.7.14
- docker.io/camunda/keycloak:26.3.3
- docker.io/camunda/operate:8.7.23
- docker.io/camunda/optimize:8.7.17
- docker.io/camunda/tasklist:8.7.23
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.7.3](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.7.3#parameters)
- Helm CLI: [3.19.2](https://github.com/helm/helm/releases/tag/v3.19.2)
...
- Camunda applications: [8.7](https://github.com/camunda/camunda/releases?q=tag%3A8.7&expanded=true)
- Camunda version matrix: [8.7](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.7)
- Helm values: [12.7.2](https://artifacthub.io/packages/helm/camunda/camunda-platform/12.7.2#parameters)
- Helm CLI: [3.19.2](https://github.com/helm/helm/releases/tag/v3.19.2)
