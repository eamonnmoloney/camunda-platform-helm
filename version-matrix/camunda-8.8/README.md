...
# Camunda 8.8 Helm Chart Version Matrix

## ToC

- [Helm chart 13.10.0](#helm-chart-13100)
- [Helm chart 13.9.1](#helm-chart-1391)
- [Helm chart 13.9.0](#helm-chart-1390)
- [Helm chart 13.8.0](#helm-chart-1380)
- [Helm chart 13.7.2](#helm-chart-1372)
- [Helm chart 13.7.1](#helm-chart-1371)
- [Helm chart 13.7.0](#helm-chart-1370)
- [Helm chart 13.6.0](#helm-chart-1360)
- [Helm chart 13.5.5](#helm-chart-1355)
- [Helm chart 13.5.4](#helm-chart-1354)
- [Helm chart 13.5.3](#helm-chart-1353)
- [Helm chart 13.5.2](#helm-chart-1352)
- [Helm chart 13.5.1](#helm-chart-1351)
- [Helm chart 13.5.0](#helm-chart-1350)
- [Helm chart 13.4.2](#helm-chart-1342)
...
- [Helm chart 13.3.0](#helm-chart-1330)
...
- [Helm chart 13.0.0-alpha7](#helm-chart-1300-alpha7)
- [Helm chart 13.0.0-alpha6](#helm-chart-1300-alpha6)
- [Helm chart 13.0.0-alpha5](#helm-chart-1300-alpha5)
- [Helm chart 13.0.0-alpha4.2](#helm-chart-1300-alpha42)
- [Helm chart 13.0.0-alpha4.1](#helm-chart-1300-alpha41)
...
- Helm values: [13.10.0](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.10.0#parameters)
...
- Camunda applications: [8.8](https://github.com/camunda/camunda/releases?q=tag%3A8.8&expanded=true)
- Camunda version matrix: [8.8](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8)
- Helm values: [13.9.1](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.9.1#parameters)
- Helm CLI: [4.1.4](https://github.com/helm/helm/releases/tag/v4.1.4)

Camunda images:

- docker.io/camunda/camunda:8.8.24
- docker.io/camunda/connectors-bundle:8.8.13
...
- Camunda applications: [8.8](https://github.com/camunda/camunda/releases?q=tag%3A8.8&expanded=true)
- Camunda version matrix: [8.8](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8)
- Helm values: [13.9.0](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.9.0#parameters)
- Helm CLI: [4.1.4](https://github.com/helm/helm/releases/tag/v4.1.4)

Camunda images:

- docker.io/camunda/camunda:8.8.24
- docker.io/camunda/connectors-bundle:8.8.12
- docker.io/camunda/console:8.8.135
- docker.io/camunda/identity:8.8.12
- docker.io/camunda/optimize:8.8.24
- docker.io/camunda/web-modeler-restapi:8.8.14
...
- Camunda applications: [8.8](https://github.com/camunda/camunda/releases?q=tag%3A8.8&expanded=true)
- Camunda version matrix: [8.8](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8)
- Helm values: [13.7.2](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.7.2#parameters)
- Helm CLI: [3.20.2](https://github.com/helm/helm/releases/tag/v3.20.2)

Camunda images:

- docker.io/camunda/camunda:8.8.23
- docker.io/camunda/connectors-bundle:8.8.10
- docker.io/camunda/console:8.8.133
- docker.io/camunda/identity:8.8.11
- docker.io/camunda/optimize:8.8.8
- docker.io/camunda/web-modeler-restapi:8.8.13
- docker.io/camunda/web-modeler-webapp:8.8.13
- docker.io/camunda/web-modeler-websockets:8.8.13
- registry.camunda.cloud/camunda/keycloak:26.3.3
...
- Camunda applications: [8.8](https://github.com/camunda/camunda/releases?q=tag%3A8.8&expanded=true)
- Camunda version matrix: [8.8](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8)
- Helm values: [13.5.3](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.5.3#parameters)
- Helm CLI: [3.20.0](https://github.com/helm/helm/releases/tag/v3.20.0)

Camunda images:

- docker.io/camunda/camunda:8.8.15
- docker.io/camunda/connectors-bundle:8.8.8
- docker.io/camunda/console:8.8.114
- docker.io/camunda/identity:8.8.9
- docker.io/camunda/keycloak:26.3.3
- docker.io/camunda/optimize:8.8.7
- docker.io/camunda/web-modeler-restapi:8.8.10
...
- Camunda applications: [8.8](https://github.com/camunda/camunda/releases?q=tag%3A8.8&expanded=true)
- Camunda version matrix: [8.8](https://helm.camunda.io/camunda-platform/version-matrix/camunda-8.8)
- Helm values: [13.5.1](https://artifacthub.io/packages/helm/camunda/camunda-platform/13.5.1#parameters)
- Helm CLI: [3.20.0](https://github.com/helm/helm/releases/tag/v3.20.0)
